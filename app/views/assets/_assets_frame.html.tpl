<section id="assets" class="tool-view is-active" data-view="assets">
  <div class="filter-toolbar">
    <form method="get" action="{{path_for "assets"}}" class="inline-form" data-controller="debounced-form" data-action="input->debounced-form#queue submit->debounced-form#submit" data-debounced-form-count-source-value="[data-assets-frame-count]" data-debounced-form-count-target-value="[data-assets-count]" data-debounced-form-delay-value="250" data-debounced-form-frame-value="assets_table" data-turbo-frame="assets_table">
